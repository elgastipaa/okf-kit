<!--
  ...
  coding/OKF/VERSION). Links SIEMPRE relativos al archivo. Borrá este comentario al usar.
...
---
okf_version: "0.1"
kit_version: "{{KIT_VERSION}}"   # okf-init lo reemplaza con el contenido de coding/OKF/VERSION
---
