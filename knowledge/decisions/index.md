...
* [El entrypoint es un mapa, no una respuesta — guardrail contra falsos positivos](0009-entrypoint-is-a-map-not-an-answer.md) - El AGENTS.md template prohíbe responder preguntas de dominio citando el propio contrato, porque una capa puede fabricar respuestas rápidas y equivocadas.
* [Hechos volátiles se generan del código, no se copian a mano](0010-generated-volatile-facts.md) - El kit ofrece template + convención para generar los hechos volátiles (script + check en CI), punto medio entre copiar (drift) y solo apuntar.
